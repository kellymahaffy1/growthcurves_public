%% Code to create Figure 2 from Donnelly, 2018
% prerequisites: run the preprocess.m function
% figures 2d & 2f are schematics and will not be generated by this code
...
figure; hold;
fig1b_indx = ismember(int_data.study_name,[1 2 3 4]);
fig1b_data = int_data(fig1b_indx, :);
for ii = 1:numel(int_group)
    indx = find(ismember(fig1b_data.record_id, int_group(ii)));
    plot(fig1b_data.int_hours(indx, :), fig1b_data.wj_brs(indx, :), '-k');
end
axis('tight');
